...
3. Simply add a ```html<script src="X-Tent.js"></script>``` element in your HTML or XML file of your app. Do NOT add the type="module" attribute in it. X-Tent.js loads as a default script file.
